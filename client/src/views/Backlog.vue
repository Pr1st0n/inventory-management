...
<style scoped>
/* Legacy view styling relocated from the former global App.vue block.
   Backlog is not yet migrated to the design system, so it keeps these
   class/element rules scoped to itself. */
.page-header h2 {
  font-size: 1.875rem;
  font-weight: 700;
  color: #0f172a;
